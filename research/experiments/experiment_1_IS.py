...
plt.title("Liquidity Backtest: In-Sample (1996-2009)")
...
# Save
plt.savefig(results_folder / "cumulative_returns_is.png", dpi=300)
...
# Save
plt.savefig(results_folder / "summary_table_is.png", dpi=300, bbox_inches="tight")
